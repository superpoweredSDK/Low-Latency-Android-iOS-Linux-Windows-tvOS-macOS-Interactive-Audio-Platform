...
/**
 ...
 @param gainStart Gain for the first sample.
 @param gainEnd Gain for the last sample. Gain will be smoothly calculated between start end end.
 @param numberOfSamples The number of samples to process.
 */
    static void simpleGain(float *input, float *output, float gainStart, float gainEnd, unsigned int numberOfSamples);
...
/**
 ...
 @param numberOfSamples The number of samples to process.
 */
    static void simpleGainAdd(float *input, float *output, float gainStart, float gainEnd, unsigned int numberOfSamples);
...
/**
 ...
 @param output Output buffer. Should be numberOfSamples * 2 + 16 big minimum. Can be equal to input (in-place).
 @param gainStart Gain for the first sample.
 @param gainChange Change gain by this amount for every sample.
 @param numberOfSamples The number of samples to process.
*/
    static void gain(float *input, float *output, float gainStart, float gainChange, unsigned int numberOfSamples);
...
/**
 ...
 @param numberOfSamples The number of samples to process.
 */
    static void gainAdd(float *input, float *output, float gainStart, float gainChange, unsigned int numberOfSamples);
...
/**
 ...
 @param numberOfSamples The number of samples to process. Should be 8 minimum, must be exactly divisible with 8.
 */
